    ...
    return (
        <div className={Styles.blogPost}>
            ...
            <div className={Styles.blogWidget}>
                ...
                <img className={Styles.authorImage} src={blogJSON.fields.author.fields.authorImage.fields.file.url} alt={`Author ${blogJSON.fields.author.fields.authorName}`} />

                <div className={Styles.widgetCopy}>
                    <p className={Styles.authorName}>By <a className={Styles.website} href={blogJSON.fields.author.fields.website ? blogJSON.fields.author.fields.website : null}>{blogJSON.fields.author.fields.authorName}</a></p>
                    <p className={Styles.publishedDate}>{format(blogJSON.fields.publishedDate)} | {contentBlogStats.text}</p>
                </div>
            ...
            <img className={Styles.mainImage} src={blogJSON.fields.blogMainImage.fields.file.url} alt="main" />
